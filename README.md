# 🚀 DemoCms - Generated Microservice Platform
...
- [ ] Open a terminal and run:
  ```bash
  git clone https://github.com/QuickCodeNet/democms.git
  ```
...
- [ ] In a new terminal, run all tests:
  ```bash
  dotnet test QuickCode.DemoCms.Docker.sln
  ```
...
**DemoCms** is a modular, enterprise-grade .NET solution generated by [quickcode.net](https://quickcode.net).  
...
democms/
  src/
    ...
    Modules/
      ...
      IdentityModule/
    Presentation/
      QuickCode.DemoCms.Gateway/
      QuickCode.DemoCms.Portal/
    Services/
    ...
  docker-compose.yml
  README.md
...
- Architecture Diagram:
  ![Architecture Diagram](https://www.quickcode.net/diagram/democms)
...
- **Gateway Dashboard:**
    ...
    - Your project: e.g. [https://democms-gateway.quickcode.net](https://democms-gateway.quickcode.net)
...
- **Portal Dashboard:**
    ...
    - Demo user credentials:
        - Username : demo@quickcode.net
        - Password : String1!
    - Your project: e.g. [https://democms-portal.quickcode.net](https://democms-portal.quickcode.net)
...
- **Gateway:**
    - link: [https://democms-gateway.quickcode.net](https://democms-gateway.quickcode.net)
- **Portal:**
    - link: [https://democms-portal.quickcode.net](https://democms-portal.quickcode.net)
- **Module APIs:**
    - link: [https://democms-identity-module.quickcode.net](https://democms-identity-module.quickcode.net)
    - etc.
...
```json
{
  "Routes": {
    "identity-module": {
      "Match": {
        "Hosts": ["democms-gateway.quickcode.net"],
  ...
  "Clusters": {
    "identity-module-api": {
      "Destinations": {
        "destination1": {
          "Address": "https://democms-identity-module.quickcode.net"
        }
      }
    }
  }
