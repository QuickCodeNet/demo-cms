...
using LoginRequest = QuickCode.DemoCms.Common.Nswag.Clients.IdentityModuleApi.Contracts.LoginRequest;


using ForgotPasswordRequest = QuickCode.DemoCms.Common.Nswag.Clients.IdentityModuleApi.Contracts.ForgotPasswordRequest;
using ResetPasswordRequest = QuickCode.DemoCms.Common.Nswag.Clients.IdentityModuleApi.Contracts.ResetPasswordRequest;
