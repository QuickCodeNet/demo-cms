...
{
    public class DomainData : BaseComboBoxModel
    {
        ...
        public DomainDto SelectedItem { get; set; }
        public List<DomainDto> List { get; set; }
    }

    public static partial class DomainExtensions
    {
        public static string GetKey(this DomainDto dto)
        {
            return $"{dto.Id}";
        }
    }
