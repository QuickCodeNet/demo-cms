...
{
    public class ThemeData : BaseComboBoxModel
    {
        ...
        public ThemeDto SelectedItem { get; set; }
        public List<ThemeDto> List { get; set; }
    }

    public static partial class ThemeExtensions
    {
        public static string GetKey(this ThemeDto dto)
        {
            return $"{dto.Id}";
        }
    }
