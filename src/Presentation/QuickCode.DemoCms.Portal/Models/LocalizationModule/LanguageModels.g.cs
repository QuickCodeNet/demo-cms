...
{
    public class LanguageData : BaseComboBoxModel
    {
        ...
        public LanguageDto SelectedItem { get; set; }
        public List<LanguageDto> List { get; set; }
    }

    public static partial class LanguageExtensions
    {
        public static string GetKey(this LanguageDto dto)
        {
            return $"{dto.Id}";
        }
    }
