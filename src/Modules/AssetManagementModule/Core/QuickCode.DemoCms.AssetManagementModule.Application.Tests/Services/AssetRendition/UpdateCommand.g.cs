...
{
    public class UpdateAssetRenditionCommandTests : IDisposable
    {
        ...
        public UpdateAssetRenditionCommandTests()
        {
        ...
        public async Task UpdateAsync_Should_Return_Success_When_Item_Exists()
        {
            ...
            var fakeGetResponse = new RepoResponse<AssetRenditionDto>(fakeDto, "Success");
            var fakeUpdateResponse = new RepoResponse<bool>(true, "Success");
            _repositoryMock.Setup(r => r.GetByPkAsync(fakeDto.Id)).ReturnsAsync(fakeGetResponse);
            _repositoryMock.Setup(r => r.UpdateAsync(It.IsAny<AssetRenditionDto>())).ReturnsAsync(fakeUpdateResponse);
            // Act
            ...
            _repositoryMock.Verify(r => r.UpdateAsync(It.IsAny<AssetRenditionDto>()), Times.Once);
        }
        ...
        public async Task UpdateAsync_Should_Return_NotFound_When_Item_Does_Not_Exist()
        {
            // Arrange
            var fakeDto = TestDataGenerator.CreateFake<AssetRenditionDto>("tr");
            var fakeGetResponse = new RepoResponse<AssetRenditionDto>
            {
            ...
            _repositoryMock.Verify(r => r.GetByPkAsync(fakeDto.Id), Times.Once);
            _repositoryMock.Verify(r => r.UpdateAsync(It.IsAny<AssetRenditionDto>()), Times.Never);
        }
