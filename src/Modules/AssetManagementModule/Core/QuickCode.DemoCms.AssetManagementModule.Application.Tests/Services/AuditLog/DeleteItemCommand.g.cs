...
using QuickCode.DemoCms.AssetManagementModule.Application.Services.AuditLog;
...
namespace QuickCode.DemoCms.AssetManagementModule.Application.Tests.Services.AuditLog
{
