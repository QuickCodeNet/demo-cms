...
{
    public class UpdatePostCommandTests : IDisposable
    {
        ...
        public async Task UpdateAsync_Should_Return_Success_When_Item_Exists()
        {
            ...
            var fakeGetResponse = new RepoResponse<PostDto>(fakeDto, "Success");
            var fakeUpdateResponse = new RepoResponse<bool>(true, "Success");
            _repositoryMock.Setup(r => r.GetByPkAsync(fakeDto.Id)).ReturnsAsync(fakeGetResponse);
            _repositoryMock.Setup(r => r.UpdateAsync(It.IsAny<PostDto>())).ReturnsAsync(fakeUpdateResponse);
            // Act
            ...
            _repositoryMock.Verify(r => r.UpdateAsync(It.IsAny<PostDto>()), Times.Once);
        }
        ...
        public async Task UpdateAsync_Should_Return_NotFound_When_Item_Does_Not_Exist()
        {
            // Arrange
            var fakeDto = TestDataGenerator.CreateFake<PostDto>("tr");
            var fakeGetResponse = new RepoResponse<PostDto>
            {
            ...
            _repositoryMock.Verify(r => r.GetByPkAsync(fakeDto.Id), Times.Once);
            _repositoryMock.Verify(r => r.UpdateAsync(It.IsAny<PostDto>()), Times.Never);
        }
