...
{
    public class ContentTagServiceDeleteTests : IDisposable
    {
        ...
        public ContentTagServiceDeleteTests()
        {
        ...
        public async Task DeleteItemAsync_Should_Return_Success_When_Item_Exists()
        {
            ...
            _repositoryMock.Setup(r => r.DeleteAsync(It.IsAny<ContentTagDto>())).ReturnsAsync(fakeDeleteResponse);
            // Act
            var result = await _service.DeleteItemAsync(fakeDto.ContentTypeKind, fakeDto.ContentId, fakeDto.TagId);
            // Assert
            Assert.Equal(ResultCodeSuccess, result.Code);
            Assert.True(result.Value);
            _repositoryMock.Verify(r => r.GetByPkAsync(fakeDto.ContentTypeKind, fakeDto.ContentId, fakeDto.TagId), Times.Once);
            _repositoryMock.Verify(r => r.DeleteAsync(It.IsAny<ContentTagDto>()), Times.Once);
        }
        ...
        public async Task DeleteItemAsync_Should_Return_NotFound_When_Item_Does_Not_Exist()
        {
            ...
            _repositoryMock.Verify(r => r.GetByPkAsync(fakeDto.ContentTypeKind, fakeDto.ContentId, fakeDto.TagId), Times.Once);
            _repositoryMock.Verify(r => r.DeleteAsync(It.IsAny<ContentTagDto>()), Times.Never);
        }
