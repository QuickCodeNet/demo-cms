...
{
    public class UpdateLanguageFallbackCommandTests : IDisposable
    {
        ...
        public UpdateLanguageFallbackCommandTests()
        {
        ...
        public async Task UpdateAsync_Should_Return_Success_When_Item_Exists()
        {
            ...
            _repositoryMock.Setup(r => r.UpdateAsync(It.IsAny<LanguageFallbackDto>())).ReturnsAsync(fakeUpdateResponse);
            // Act
            var result = await _service.UpdateAsync(fakeDto.LanguageId, fakeDto.FallbackLanguageId, fakeDto);
            // Assert
            Assert.Equal(ResultCodeSuccess, result.Code);
            Assert.True(result.Value);
            _repositoryMock.Verify(r => r.GetByPkAsync(fakeDto.LanguageId, fakeDto.FallbackLanguageId), Times.Once);
            _repositoryMock.Verify(r => r.UpdateAsync(It.IsAny<LanguageFallbackDto>()), Times.Once);
        }
        ...
        public async Task UpdateAsync_Should_Return_NotFound_When_Item_Does_Not_Exist()
        {
            ...
            _repositoryMock.Verify(r => r.GetByPkAsync(fakeDto.LanguageId, fakeDto.FallbackLanguageId), Times.Once);
            _repositoryMock.Verify(r => r.UpdateAsync(It.IsAny<LanguageFallbackDto>()), Times.Never);
        }
