...
{
    public class SiteLanguageServiceDeleteTests : IDisposable
    {
        ...
        public SiteLanguageServiceDeleteTests()
        {
        ...
        public async Task DeleteItemAsync_Should_Return_Success_When_Item_Exists()
        {
            ...
            _repositoryMock.Setup(r => r.DeleteAsync(It.IsAny<SiteLanguageDto>())).ReturnsAsync(fakeDeleteResponse);
            // Act
            var result = await _service.DeleteItemAsync(fakeDto.SiteId, fakeDto.LanguageId);
            // Assert
            Assert.Equal(ResultCodeSuccess, result.Code);
            Assert.True(result.Value);
            _repositoryMock.Verify(r => r.GetByPkAsync(fakeDto.SiteId, fakeDto.LanguageId), Times.Once);
            _repositoryMock.Verify(r => r.DeleteAsync(It.IsAny<SiteLanguageDto>()), Times.Once);
        }
        ...
        public async Task DeleteItemAsync_Should_Return_NotFound_When_Item_Does_Not_Exist()
        {
            ...
            _repositoryMock.Verify(r => r.GetByPkAsync(fakeDto.SiteId, fakeDto.LanguageId), Times.Once);
            _repositoryMock.Verify(r => r.DeleteAsync(It.IsAny<SiteLanguageDto>()), Times.Never);
        }
