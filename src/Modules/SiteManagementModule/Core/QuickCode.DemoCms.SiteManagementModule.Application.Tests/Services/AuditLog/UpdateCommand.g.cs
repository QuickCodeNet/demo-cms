...
using QuickCode.DemoCms.SiteManagementModule.Application.Services.AuditLog;
...
namespace QuickCode.DemoCms.SiteManagementModule.Application.Tests.Services.AuditLog
{
